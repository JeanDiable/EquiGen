...
from models.nn.layers.base import BaseLayer, GeneralSetLayer
from models.nn.layers.bias_to_bias import BiasToBiasBlock
from models.nn.layers.bias_to_weight import BiasToWeightBlock
from models.nn.layers.weight_to_bias import WeightToBiasBlock
from models.nn.layers.weight_to_weight import WeightToWeightBlock
...
class InvariantLayer(BaseLayer):
    ...
    def forward(self, x: Tuple[Tuple[torch.tensor], Tuple[torch.tensor]]):
        ...
        last_b = biases[-1]
        # print("last_b.shape", last_b.shape)
        # (bs, dL * in_features)
        pooled_last_b = last_b.flatten(start_dim=1)
        # print("pooled_last_b.shape", pooled_last_b.shape)
        ...
        # print("pooled_weights.shape", pooled_weights.shape)
        ...
        # print("pooled_biases.shape", pooled_biases.shape)
        ...
        # print("pooled_all.shape", pooled_all.shape)
        return pooled_all, self.layer(pooled_all)
